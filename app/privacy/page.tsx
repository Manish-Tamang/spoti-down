      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto prose prose-gray">
            ...
            <p>
              At SpotiDown, we respect your privacy and are committed to protecting your personal data. This Privacy
              Policy explains how we collect, use, and safeguard your information when you use our website and services.
            </p>
            <p>
              Please read this Privacy Policy carefully. By using SpotiDown, you consent to the practices described in
              this policy.
            </p>
            ...
            <ul>
              <li>
                <strong>Personal Data:</strong> Email address, name, and other contact information you provide when
                creating an account or contacting support.
              </li>
              <li>
                <strong>Usage Data:</strong> Information about how you use our Service, including the Spotify links you
                convert, frequency of use, and features accessed.
              </li>
              <li>
            ...
            <h2>10. Contact Us</h2>
            <p>If you have any questions about this Privacy Policy, please contact us at privacy@spotidown.com.</p>
          </div>
        </div>
      </section>
    </div>
